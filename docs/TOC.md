...
## [Создание и публикация пакета .NET Standard (dotnet CLI)](quickstart/create-and-publish-a-package-using-the-dotnet-cli.md)
...
### [Создание элементов управления пользовательским интерфейсом в виде пакетов NuGet](guides/create-UI-controls.md)
...
### [обновить](tools/cli-ref-update.md)
...
## [Требуемые версии .NET Framework](reference/target-frameworks.md)
...
### [project.json и UWP](archive/project-json-and-uwp.md)
...
### [Отправка пакетов символов](api/symbol-package-publish-resource.md)
...
# [Часто задаваемые вопросы](faqs/nuget-faq.md)
