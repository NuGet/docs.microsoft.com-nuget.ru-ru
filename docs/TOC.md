...
### [добавление](reference/cli-reference/cli-ref-add.md)
...
### [Установка](reference/cli-reference/cli-ref-install.md)
...
### [восстановление](reference/cli-reference/cli-ref-restore.md)
...
### [обновить](reference/cli-reference/cli-ref-update.md)
...
### [Пределы скорости](api/rate-limits.md)
...
## [Часто задаваемые вопросы](resources/nuget-faq.md)
