1. <span data-ttu-id="3ec1a-101">Перейдите в папку, содержащую файл `.nupkg`.</span><span class="sxs-lookup"><span data-stu-id="3ec1a-101">Change to the folder containing the `.nupkg` file.</span></span>
