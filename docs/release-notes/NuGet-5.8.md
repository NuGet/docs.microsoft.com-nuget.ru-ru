...
* Проверьте подписанные пакеты NuGet с помощью новой [`dotnet nuget verify`](/dotnet/core/tools/dotnet-nuget-verify) команды [#8051](https://github.com/NuGet/Home/issues/8051)
