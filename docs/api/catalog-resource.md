...
----------------------- | -------------------------- | -------- | -----
authors                 | string                     | Нет       |
created                 | string                     | Нет       | Отметку времени, при первом создании пакета. Резервный свойство: `published`.
...
Описание             | string                     | Нет       |
iconUrl                 | string                     | Нет       |
isPrerelease            | boolean                    | Нет       | Ли версия пакета является предварительной версией. Могут быть обнаружены с `version`.
язык                | string                     | Нет       |
