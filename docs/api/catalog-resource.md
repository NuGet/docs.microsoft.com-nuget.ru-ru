...
count           | Целое число          | да      | Число страниц в индексе
...
count           | Целое число | да      | Число элементов на странице каталога
...
коммитид        | строка           | да      | Уникальный идентификатор, связанный с последней фиксацией на этой странице
коммиттиместамп | строка           | да      | Метка времени последней фиксации на этой странице
count           | Целое число          | да      | Число элементов на странице
...
паккажесизе             | Целое число                    | да      | Размер пакета. nupkg в байтах
