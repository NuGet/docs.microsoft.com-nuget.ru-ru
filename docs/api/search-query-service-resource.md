...
На сайте nuget.org проверенного пакета источник, который имеет идентификатор пакета, сопоставления зарезервированный префикс идентификатора и принадлежит одному из владельцев зарезервированному пространству имен. Дополнительные сведения см. в разделе [документацию о резервирование префикса идентификатора](../reference/id-prefix-reservation.md).
