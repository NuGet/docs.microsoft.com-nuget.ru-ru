...
| Переустановите | Resintalls пакетов с помощью текущей установленной версии. В разделе [путем переустановки и обновления пакетов](../consume-packages/reinstalling-and-updating-packages.md). |
