...
1. Если ссылки на пакет в файле проекта правильные, используйте привычное средство для восстановления пакетов.
   ...
   Если ссылки на пакет в файле проекта неправильные, (не соответствуют требуемому состоянию после восстановления пакета), необходимо установить или обновить пакеты.
