...
См. подробнее о [профилях Windows PowerShell](/previous-versions//bb613488(v=vs.85)).

## <a name="use-the-nugetexe-cli-in-the-console"></a>Использование CLI nuget.exe в консоли

Чтобы добавить [CLI`nuget.exe`](../reference/nuget-exe-cli-reference.md) в консоль диспетчера пакетов, установите пакет [NuGet.CommandLine](https://www.nuget.org/packages/NuGet.CommandLine/) из консоли.
