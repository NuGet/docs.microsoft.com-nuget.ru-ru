...
> [!Important]
> Паккажеиконурл не рекомендуется использовать с NuGet 5.3 + & Visual Studio 2019 версии 16.3 +. Вместо этого используйте [паккажеикон](#packing-an-icon-image-file) .
