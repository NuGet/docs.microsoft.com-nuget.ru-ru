...
[Значок пакета nuspec Sample.](https://github.com/NuGet/Samples/tree/main/PackageIconNuspecExample)
...
Для эквивалента MSBuild ознакомьтесь с [упаковкой файла сведений](msbuild-targets.md#packagereadmefile). 
