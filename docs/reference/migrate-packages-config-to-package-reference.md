...
1. Migrator анализирует ссылки на пакеты NuGet проекта и предпринимается попытка классифицировать их в **зависимостей верхнего уровня** (NuGet пакеты этого каталога вы установили) и **транзитивные зависимости**(пакеты, установленные как зависимости пакетов верхнего уровня).
