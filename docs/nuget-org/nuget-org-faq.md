...
5. Перейдите на сайт [https://www.nuget.org/account/transform](https://www.nuget.org/account/transform). Это позволит вам преобразовать учетную запись NuGet.org в организацию без связывания с учетной записью Майкрософт.
