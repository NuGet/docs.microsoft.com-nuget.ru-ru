...
<span data-ttu-id="4c8d7-118">где `<package(s)>` — это один или несколько `.nupkg` файлов.</span><span class="sxs-lookup"><span data-stu-id="4c8d7-118">where `<package(s)>` is one or more `.nupkg` files.</span></span>
