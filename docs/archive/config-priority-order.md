### <a name="priority-ordering"></a><span data-ttu-id="ba77d-101">Упорядочение по приоритетам</span><span class="sxs-lookup"><span data-stu-id="ba77d-101">Priority ordering</span></span>
