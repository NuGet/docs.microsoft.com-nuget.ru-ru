...
Несмотря на то, что он не является обязательным для реализации сервера для хранения регистрации листов в отдельной регистрации Многостраничные документы, он рекомендуется в целях экономии памяти на стороне клиента. Вместо встроив все регистрации оставляет в индексе или непосредственно хранение оставляет в Многостраничные документы, рекомендуется определить, серверной реализации определенной эвристики для выбора между двумя способами, в зависимости от числа версий пакета или оставляет совокупный размер пакета.
