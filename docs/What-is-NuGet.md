...
| [Управление пользовательским интерфейсом NuGet](/visualstudio/mac/nuget-walkthrough) | Visual Studio для Mac | Потребление | Предоставляет удобный пользовательский интерфейс для установки пакетов и управления ими в проектах .NET. |
