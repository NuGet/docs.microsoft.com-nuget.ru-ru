...
---
# <a name="44-rtm-release-notes"></a>Заметки о выпуске версии 4.4 RTM
...
* Команда dotnet add package может очистить пустые строки из файла CSPROJ — [#5697](https://github.com/NuGet/Home/issues/5697)
...
* Команда dotnet pack работает по-разному в зависимости от того, используется ли TargetFramework или TargetFrameworks — [#5281](https://github.com/NuGet/Home/issues/5281)
...
## <a name="link-to-github-issues-fixed-in-44-rtm"></a>Ссылка на проблемы GitHub, исправленные в версии 4.4 RTM
