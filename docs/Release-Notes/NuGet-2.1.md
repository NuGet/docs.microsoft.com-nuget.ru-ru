...
## <a name="specify-packages-folder-location"></a><span data-ttu-id="77c7c-121">Укажите «пакеты» расположение папки</span><span class="sxs-lookup"><span data-stu-id="77c7c-121">Specify ‘packages’ Folder Location</span></span>
